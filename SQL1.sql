...
select customer_id from customer where discount_applied='Yes' 
...
select shipping_type, ROUND(avg(purchase_amount),2) as avg_purchased_amount from customer 
...
--purchases, and show the count of each segments.
